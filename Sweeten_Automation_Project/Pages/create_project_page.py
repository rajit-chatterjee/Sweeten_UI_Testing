'''
Functionalities of Create Project Page
'''
...
log=logger.set_log("create project page")
...
def click_submit(browser):
    submit_btn=cf.find_an_element(browser, locator.find_by_xpath, locator.project_submitproject_btn_xpath)
